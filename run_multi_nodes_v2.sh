...
#    autograd error
#train_config=conf/zipformer2_multi_mode_0.2B.yaml
train_config=conf/conformer_aed_conformer_0.2B.yaml
dir=exp/zh_k2_prune_0.2B_v20260203_multimode
tensorboard_dir=tensorboard
checkpoint= #exp/zh_k2_prune_0.1B_v20260108_multimode/step_24999.pt
num_workers=4
prefetch=4
