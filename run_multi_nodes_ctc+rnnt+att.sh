...
#    autograd error
train_config=conf/conformer_rnnt_ctc_aed_0.2B.yaml
dir=exp/zh_k2_prune_ctc_rnnt_att_0.2B_1120
tensorboard_dir=tensorboard
checkpoint= #exp/zh_k2_prune_0.2B/step_299999.pt
num_workers=4
prefetch=4
...
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
  ...
  torchrun --nnodes=$num_nodes --nproc_per_node=$num_gpus \
    ...
    wenet/bin/train.py \
      ...
      --override_config optim_conf.lr=0.001
