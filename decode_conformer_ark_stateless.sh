...
#dir=exp/zh_k2_prune_0.2B_v20260205_stateless/
dir=exp/zh_k2_prune_0.2B_v20260304_predictor_lstm4/
decode_checkpoint=step_194999.pt
decode_yaml=step_194999.yaml
...
result_dir=$dir/$(basename $decode_checkpoint .pt)_chunk_${decoding_chunk_size}_cache_${num_decoding_left_chunks}_rever0
