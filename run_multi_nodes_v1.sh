...
#    autograd error
train_config=conf/conformer_rnnt_0.2B.yaml
dir=exp/zh_k2_prune_0.2B_1114
tensorboard_dir=tensorboard
checkpoint=exp/zh_k2_prune_0.2B/step_299999.pt #/mnt/lustre/hpc_stor01/home/chenghao.zhao/work25/wenet-shengteng-lixu/exp/zh_251010_v1_rnnt_ctc_0.2B_8nodes/step_49999.pt #exp/zh_251010_v1_rnnt_ctc_0.5B/step_1169999.pt
num_workers=4
prefetch=4
...
if [ ${stage} -le 4 ] && [ ${stop_stage} -ge 4 ]; then
  ...
  torchrun --nnodes=$num_nodes --nproc_per_node=$num_gpus \
    ...
    wenet/bin/train.py \
      ...
      --config $train_config \
      --data_type  $data_type \
      --train_data data_debug/$train_set/train/data.jsonl \
      --cv_data data_debug/$train_set/dev/data.jsonl \
      ...
      --prefetch ${prefetch} \
      --pin_memory \
      --override_config init_infos.step=0 \
      --override_config init_infos.epoch=0 \
      --override_config init_infos.tag=init \
      --override_config optim_conf.lr=0.0005
